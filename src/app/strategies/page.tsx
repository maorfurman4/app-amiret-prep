...
const INVEST_POINTS = [
  ...
  },
  {
    ...
    body:
      ...
      'האתר עדיין אינו מדמה את סוגי השמע, יצירת המילים, הדקדוק בהקשר או הכתיבה; הפרק האחרון בסימולציה הוא תרגול חלופי בלבד. מומלץ להתייחס ברצינות לכל פרק שמופיע בבחינה, משום שלא בוחרים מראש איזו חלופה מקבלים.',
  },
];
