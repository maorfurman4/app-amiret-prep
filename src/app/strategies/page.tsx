...
const INVEST_INTRO =
  'תקציב הזמן (בנושא הקודם) קובע גבולות אחידים — אבל בפועל, לא כל דקה חורגת שווה אותו דבר מבחינת הציון. יש שלושה מקומות ספציפיים במבנה המבחן שבהם דקה נוספת באמת משנה תוצאה, ' +
